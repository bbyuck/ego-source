  ...
  <div class="center" id="position_page">
    ...
    <div class="position_line">
      ...
      <div class="adc">
        ...
        <div class="content_btm">
          <v-ons-button class="favorite_btn fa-adc" v-if="adcarry" v-on:click="selectMainPosition(3)">
            <i class="far fa-star"></i>
          </v-ons-button>
        </div>
      </div>
      ...
      <div class="sup">
        ...
        <div class="content_btm">
          <v-ons-button class="favorite_btn fa-sup" v-if="support" v-on:click="selectMainPosition(4)">
            <i class="far fa-star"></i>
          </v-ons-button>
        </div>
      </div>
...
.icon-top, .icon-jungle, .icon-mid, .icon-adcarry, .icon-support {
  font-size: 2.5em;
  position: relative;
  left: 0.01em;
  bottom: 0.2em;
...
.main_position_show > .icon-top, .main_position_show > .icon-jungle, .main_position_show > .icon-mid, .main_position_show > .icon-adcarry, .main_position_show > .icon-support {
  font-size: 1em;
}
...
.position_btn:active:before, .position_btn.on:before {
	top: -5px;
	background-color: rgb(26,27,29);
	box-shadow: 0px 1px 0px 0px rgba(250,250,250,0.1), 
			 	inset 0px 1px 2px rgba(0, 0, 0, 0.5);

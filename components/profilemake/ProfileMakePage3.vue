<template>
  <div class="page_content">
    ...
    <div class="champion_area">
      <div class="champion_btn_container" v-bind:style="{ height: championImgSize + 'px'}" v-for="champion in championArr" v-bind:key="champion.index" v-if="champion.koreanName.includes(searchInput)"> 
